<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
    ...
    <ul class="space-y-2 font-medium">
        <x-admin.nav-link href="/admin/beranda" :active="request()->is('admin/beranda')">
        ...
        <x-admin.nav-link href="/admin/compaign" :active="request()->is('admin/compaign')">
            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            <path fill-rule="evenodd" d="M12 4a4 4 0 1 0 0 8 4 4 0 0 0 0-8Zm-2 9a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a4 4 0 0 0-4-4h-4Z" clip-rule="evenodd"/>
            </svg>
            <span class="flex-1 ms-3 whitespace-nowrap">Compaig/Event</span>
        </x-admin.nav-link>

        <x-admin.nav-link href="/admin/riwayat-donasi" :active="request()->is('admin/riwayat-donasi')">
            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            ...
            <span class="ms-3">Riwayat Donasi</span>
        </x-admin.nav-link>

        <x-admin.nav-link href="/admin/pencairan-dana" :active="request()->is('admin/pencairan-dana')">
            ...
            <span class="ms-3">Pencairan Dana</span>
        </x-admin.nav-link>
    </ul>
    </div>
</aside>